...
public class OVRGrabber : MonoBehaviour
{
    ...
    // Event to declare when a new object is grabbed
    public UnityEvent newObjectGrabbed;
    ...
    //  This is where you could count the number of grabs
    protected virtual void GrabBegin()
    {
        ...
        {
            // This part marks a successful grab
            // If it is the object's first time being grabbed, we should count it
            if (!closestGrabbable.isCounted)
            {
